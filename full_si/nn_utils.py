"""
Using code adapted from Till's work for application in vaccination trial simulation
"""
...
class MixtureDensityNetwork_multi_param_gamma(th.nn.Module):
    """
    Simple Gamma mixture density network.
    Args:
    ...
    def forward(self, x: th.Tensor) -> th.distributions.Distribution:
        ...
        # M: This breaks a and b into a list of triples (or as many parameters as needed.)
        ...
        component_distribution = th.distributions.Independent(th.distributions.Gamma(a, b), 1)
             # M: The Affine Transform makes sure that we keep the range within [0,10]
