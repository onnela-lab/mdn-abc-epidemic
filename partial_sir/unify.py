...
# Simple script to gather the samples
# mode is the category of data to gather (e.g. training, validation, etc.)
# num_threads is the number of parallel threads the data is generated in.
...
file_name = "data/" + str(mode) + "_README.txt"
with open(file_name, "w") as f:
	f.write("Shapes: " + str(all_samples[k].shape))
